...
echo "HOST: $SLURM_SUBMIT_HOST @ $SLURM_JOB_ACCOUNT, CLUSTER: $SLURM_CLUSTER_NAME ($SLURM_JOB_PARTITION), SLURM_DISTRIBUTION: $SLURM_DISTRIBUTION"
echo "JOBname: $SLURM_JOB_NAME, ID: $SLURM_JOB_ID, WRK_DIR: $SLURM_SUBMIT_DIR, "
echo "nNODES: $SLURM_NNODES, NODELIST: $SLURM_JOB_NODELIST, NODE_ID: $SLURM_NODEID"
echo "nTASKS: $SLURM_NTASKS, nPROCS: $SLURM_NPROCS"
...
echo "TASKS/NODE: $SLURM_TASKS_PER_NODE, THREADS/CORE: $SLURM_THREADS_PER_CORE"
echo "${stars// /*}"
