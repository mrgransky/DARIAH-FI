...
def main():
	try:
		print(os.listdir(dfs_path))
		print([f for f in os.listdir(dfs_path) if re.match(r"_concat.lz4", f)])
		df_concat_fname = [f for f in os.listdir(dfs_path) if re.match(r"_concat.lz4", f)][0]
