...
srun -J v100_interactive --account=project_2004072 --partition=gputest --gres=gpu:v100:1 --time=0-00:15:00 --mem-per-cpu=64G --ntasks=1 --cpus-per-task=1 --pty /bin/bash -i
