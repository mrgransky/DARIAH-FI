...
srun -J v100_interactive --account=project_2004072 --partition=gputest --gres=gpu:v100:1 --time=0-03:59:00 --mem-per-cpu=48G --ntasks=1 --cpus-per-task=1 --pty /bin/bash -i
