	...
	try:
		...
		lemmas_list = [
			...
			if (
				...
				and not re.search(r'\b(?=\d|\w)(?:\w*(?<!\b)(\w)(\1{2,})\w*|\d+\w*|\w*\d\w*)\b|<ros>|<eos>|/|<EOS>|<sos>|<SOS>|<UNK>|<unk>|\?|\^|\s+', wlm) # excludes words containing digits!
				and not re.search(
					r"(nens|bolags|bolaget|bolagets|akatemias|sonia|yrket|filmer|yrkets|vänner|vännen|kvällar|kvällen|kvällens|dagl|tjänster|kurser|gatta|gatas|gatorna|gator|gatare|fabriker|riks|möt|möter|kyrkan|hyrans|hyran|huset|husets|hemmet|hemmets|hems|ters|handl|hamns|hamna|kvinn|pojkens|pojkar|pojkars|kvinnan|kvinnans|kvinnor|litets|manista|manille|manilla|manill|manilta|manilt|mania|mans|manin|dagar|dagars|dagen|dagens|dagens|daga|agaren|agarna|agarens|agares|borga|borgs|borge|dotters|dott|skolan|skolans|skillnaden|erna|ernas|garna|garnas|skillnader|heten|heter|hetens|avgiften|avgiftens|avgifter|kaupungissa|kaupungista|kaupungit|gatans|bergs|tionen|tioner|tionens|statio|tiona|tions|tionerne|tione|ingen|ingana|regeringa|ingaina|ingania|ingens|ingene|ingar|ingarna|ingarnas|ringarne|systems|principen|principer|bergin|gatan|grens|sons|lunde|lunda|lunds|lundille|lundilta|lundilla|lundiin|lundia|lundin|lundissa|holms|mens|holme|stads|stadens)$", 
					wlm
				) # safer...
