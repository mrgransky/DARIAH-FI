...
with HiddenPrints():
	...
	my_custom_stopwords = ['btw', "could've", "n't","'s","—", "i'm", "'m", 
													...
													'talamodh', 'talap', 'talapfi', 'talarc', 'talarn', 'talarpla', 'talaslcrh', 'talausjärjcskelniä', 'talblti', 'mäßig', 'wähy',
													...
													'abg', 'aabg', 'aabcli', 'aabcl', 'aabclt', 'aabcnra', 'aabu', 'aach', 'aache', 'ache', 'achi', 'aachcn', 'aacce', 'aadbr', 'adbi', 'adb', 'aadbq', 'aabaßfeen',
													'aabcd', 'aabc', 'lop', 'chr', 'lli', 'lhyww', 'ttll', 'lch', 'lcg', 'lcf', 'lcfv', 'nsö', 'chp', 'pll', 'jvk', 'aacfca', 'aahpo', 'aacli', 'aafj', 'aafl', 'aaclönvut',
													'aabol', 'aabotr', 'aabo', 'aabne', 'abj', 'aabj', 'aabra', 'aabram', 'tipn', 'cfr', 'pltt', 'vpl', 'pustl', 'cbsa', 'alj', 'aall', 'efo', 'aafo', 'aago', 'aagot',
													'qal', 'qam', 'dta', 'itft', 'aabaari', 'aabbcc', 'aabdl', 'aabamiu', 'aabham', 'aabho', 'aabhe', 'aabh', 'aabeck', 'aabergi', 'aabesti', 'aababi', 'aabach', 'aaein', 'aaekcta',
													...
													'aaefitfi', 'aaeh', 'aaeho', 'aaencaßapt', 'aadl', 'aadlf', 'aadintr', 'aacjo', 'aacj', 'aacjjhisnnrv', 'aadw', 'aadwmon', 'aaed', 'aactci', 'aacftrja', 'aace', 'aabna',
													'aacftrja', 'aaelgn', 'aael', 'aaeli', 'aaeltpo', 'aaeife', 'aacxflmh', 'efr', 'luu', 'ino', 'aabs', 'aadolrl', 'aaeo', 'affi', 'aaffi', 'aahfi', 'aaha', 'aaceßtkeßy', 'ader',
													'aado', 'aabnd', 'aafe', 'aacv', 'aaci', 'aadaminp', 'aacfo', 'aacne', 'aactraejcs', 'aaddodaannddnnandd', 'aacmk', 'aacfuak', 'aacd', 'aeuo', 'aaboc', 'aacdsöri', 'aabldtech',
													'aadolf', 'aadolfa', 'aadolffi', 'aadolfi', 'aadolfin', 'aadolfink', 'aadiiri', 'aabcpk', 'aabcu', 'aabwl', 'aaccid', 'aabtek', 'acjg', 'aahanno', 'ljd', 'tts', 'gna', 'aabtrt',
													'aacdmo', 'aadgl', 'aadll', 'aadnmukko', 'aem', 'aaem', 'aadu', 'aaduaa', 'aadvlkae', 'aadwmn', 'aadä', 'aaea', 'aaeac', 'aaee', 'aaeie',  'aahc', 'aahcm', 'aachenirf', 'aabmsfc',
													'aaeka', 'aadol', 'aaeeva', 'aacti', 'aaclo', 'aacno', 'aacnos', 'abm', 'abmi', 'aabmi', 'aabmsp', 'aacla', 'aadalsg', 'aadof', 'aadr', 'aadru', 'ahtcc', 'aacamfa', 'aaca', 'aacatjji',
													...
													'aabatjec', 'aabcnras', 'aaballan', 'aabdatonta', 'aatl', 'aatnu', 'aatlnt', 'aabaatl', 'aabcbm', 'aabci', 'aabekatt', 'aabeq', 'acä', 'adalrnina', 'aabmwwb', 'aaboxi',
													...
													'aabaaieililtt', 'aabama', 'aabava', 'adamjo', 
													]
