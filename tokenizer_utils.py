...
with HiddenPrints():
	...
	my_custom_stopwords = ['btw', "could've", "n't","'s","—", "i'm", "'m", 
													...
													'jfe', 'ifc', 'flfl', 'bml', 'zibi', 'ibb', 'bbß', 'sfr', 'yjet', 'stm', 'imk', 'sotmt', 'oslfesfl', 'anoth', 'vmo', 'uts', 'abf', 
													...
													'psr', 'jay', 'ifr', 'jbl', 'iffi', 'ljjlii', 'jirl', 'nen', 'rwa', 'tla', 'mnn', 'jfa', 'omp', 'lnna', 'nyk', 'fjjg', 'taflhßtiß', 'ablbt',
													...
													'bia', 'bex', 'bhrci', 'bib', 'bibi', 'bii', 'iea', 'ёск', 'aablta', 'aabl', 'aabi', 'aabil', 'aabittaisitii', 'aabj', 'aabm', 'aabesti',
													'aaer', 'aaes', 'aafarif', 'aafcfcfc', 'aafci', 'aaeio', 'adabl', 'aacnti', 'aaby', 'aabaiyyntl', 'aabia', 'aabfos', 'aabio',
													'abg', 'aabg', 'aabclt', 'aabcnra', 'aabu', 'aach', 'aache', 'aachcn', 'aacce', 'aadbq', 'aaeng', 'aabfsa',
													'aabcd', 'aabc', 'aabcli', 'aabcl', 'lop', 'chr', 'lli', 'lhyww', 'ttll', 'lch', 'lcg', 'lcf', 'lcfv', 'nsö', 'chp', 'pll', 'jvk', 'aacfca', 'aabra', 'aahpo', 'aacli',
													'aabol', 'aabotr', 'aabo', 'aabne', 'abj', 'aabj', 'aabram', 'tipn', 'cfr', 'pltt', 'vpl', 'pustl', 'cbsa', 'alj', 'aall', 'efo', 
													'qal', 'qam', 'dta', 'itft', 'aabaari', 'aabbcc', 'aabdl', 'aabamiu', 'aabham', 'aabho', 'aabeck', 'aabergi', 'aabelki', 'aababi', 'aabach',
													...
													'aaefitfi', 'aaeh', 'aaeho', 'aaencaßapt', 'aadl', 'aadlf', 'aadintr', 'aacjjhisnnrv', 'aadbr', 'aadw', 'aadwmon', 'aaed', 'aactci', 'aacftrja', 'aace', 'aaceßtkeßy', 
													'aacftrja', 'aaelgn', 'aael', 'aaeli', 'aaeltpo', 'aaeife', 'aaema', 'aacxflmh', 'efr', 'luu', 'ino', 'aabs', 'aadolrl', 'aaeo', 'aaffi', 'aahfi', 'aaha',
													'aadmf', 'aado', 'aabnd', 'aafe', 'aacv', 'aaci', 'aadaminp', 'aacfo', 'aacne', 'aactraejcs', 'aaddodaannddnnandd', 'aacmk', 'aacfuak', 'aaca', 'aacd', 'aacjo',
													'aadolf', 'aadolfa', 'aadolffi', 'aadolfi', 'aadolfin', 'aadolfink', 'aadiiri', 'aabcpk', 'aabcu', 'aabwl', 'aaccid', 'aabtek', 'aahopf', 'acjg',
													'aacdmo', 'aadgl', 'aadll', 'aadnmukko', 'aaem', 'aadu', 'aaduaa', 'aadvlkae', 'aadwmn', 'aadä', 'aaea', 'aaeaau', 'aaeac', 'aaee', 'aaeie', 'aaem', 'aczi', 'aahc', 'aahcm',
													'aaeka', 'aadol', 'aaeeva', 'aacti', 'aaclo', 'aacnos', 'aaca', 'abm', 'abmi', 'aabmi', 'aabmsp', 'aacla', 'aadalsg', 'aadof', 'aadr', 'aadru', 'aahmhmnßumrumhaammhmnn',  
													'aahv', 'aahve', 'aahß', 'aaia', 'aaiani', 'aaie', 'aaiia', 'aaifi', 'aaifn', 'aaiel', 'aaiio', 'aaiitj', 'aaija', 'aaikslla', 'aaila', 'aaile', 'aaili', 'aaho', 'aaeb',
													...
													'agjls', 'aglksr', 'aglxvä', 'agrr', 'ags', 'agsb', 'agsjm', 'agsk', 'agsm', 'agtl', 'agtm', 'ahc', 'ahcs', 'aaim', 'aaini', 'aain', 'aaioaj', 'aaionk', 'aagmt', 'aabaife',
													'aafl', 'aage', 'aaftc', 'aafsr', 'aaent', 'aaen', 'aacmak', 'aacs', 'aacoßi', 'aadarr', 'aade', 'aadho', 'aadltu', 'aadev', 'aaenklo', 'aaesßgo', 'aaeto', 'aabh', 'aaberrci',
													'aabcdefgh', 'aabcdefghi', 'aabcdefghij', 'aabbau', 'aabbe', 'aabbergetleatern', 'aabber', 'aabb', 'aabbsaa', 'aabbt',  'aabba', 'aabbsk', 'aabbss', 'aabama', 'aabava', 
													...
													'aabalf', 'aabf', 'aabffl', 'aabfd', 'aabafli', 'aabbd', 'aabend', 'aabara', 'aabbl', 'aabbmbi', 'aabca', 'aabcabiibi', 'aabani', 'aabafs', 'aabenta', 'aabakko', 'aabate', 
													'aabenjaa', 'aabaau', 'aaband', 'aabanv', 'aabattu', 'aabbo', 'aabejbro', 'aabaek', 'aabala', 'aabberg', 'aabebkramlare', 'aabenraag', 'aabenraagi', 'aabaljoki', 'aabbad', 
													'aabatjec', 'aabcnras', 'aaballan', 'aabhe', 'aabdatonta', 'aabaatl', 'aabcbm', 'aabci', 'aabekatt', 'aabeq', 'aabfo', 'aabika', 'aabaffccii', 'aabenfa', 'aabaiajajaeftsß',
													]
