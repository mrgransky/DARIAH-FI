...
with HiddenPrints():
	...
	my_custom_stopwords = ['btw', "could've", "n't","'s","—", "i'm", "'m", 
													...
													'hpl', 'tpv', 'vrpl', 'rpl', 'jtihiap', 'nii', 'nnf', 'aää', 'jofc', 'lxx', 'vmll', 'sll', 'vlli', 'pernstclln', 'nttä', 'npunl', 'aln', 'aakf', 'aakfco', 'aalj', 
													'aalflm', 'aaltpi', 'aaltqa', 'aalß', 'aalv', 'aalvt', 'aalw', 'taalß', 'aam', 'laam', 'taam', 'taamctli', 'taan', 'taawatwßki', 'taaßffrr', 'taaßxmm', 'afctitf',
													'öjj', 'öjo', 'öio', 'öiibi', 'öij', 'öbb', 'öba', 'åvq', 'åvp', 'åvl', 'åyr', 'åjj', 'åji', 'åjk', 'åff', 'åfgr', 'äåg', 'fjlmi', 'aak', 'aakcl', 'aalg', 'manuf',
													'ink', 'ksi', 'ctr', 'dec', 'fmf', 'ull', 'prof', 'sco', 'jjö', 'tcnko', 'itx', 'tcnkck', 'kello', 'jnho', 'infji', 'jib', 'ämj', 'aajr', 'aajwu', 'aald', 
													'afu', 'ieo', 'ebep', 'tnvr', 'nta', 'tlyllal', 'viv', 'sån', 'hitl', 'vrt', 'pohj', 'nky', 'ope', 'ftm', 'tfflutti', 'aajaj', 'aajl', 'aalf', '8elegram',
													...
													'aabd', 'aabx',  'aabn', 'aabnrxii', 'aabr', 'aabt', 'aabä', 'aaco', 'aacßon', 'aad', 'aae', 'aafwvwvn', 'aagsßas', 'aagxt', 'aaiißofl', 'aaiiu', 'aaijsi',
													...
													'talamodh', 'talap', 'talapfi', 'talarc', 'talarn', 'talarpla', 'talaslcrh', 'talausjärjcskelniä', 'talblti', 'mäßig', 'wähy', 'eii', 'eln', 'aabso', 'aacbe',
													...
													'eft', 'efu', 'efä', 'efö', 'ega', 'ege', 'egi', 'egl', 'egn', 'egr', 'ehd', 'ehe', 'ehkk', 'ehl', 'ehn', 'ehr', 'eht', 'ehu', 'ehy', 'eia', 'eie', 'eif', 'eig', 
													...
													'bia', 'bex', 'bhrci', 'bib', 'bibi', 'bii', 'iea', 'ёск', 'aabm', 'aadtma', 'aadojf', 'aabdnsbabbmbfibnhbi', 'aabacm', 'aabchmsm', 'aabme', 'aabbhl', 'aabtaßliait',
													'aaer', 'aaes', 'aafarif', 'aaeio', 'adabl', 'aacnti', 'aaby', 'aabaiyyntl', 'aadut', 'aadla', 'aadtaajsti', 'aaeu', 'aeu', 'aeuu', 'aabdce', 'aabto', 'aacgioj',
													'abg', 'aabg', 'aabcli', 'aabcl', 'aabclt', 'aabu', 'aach', 'aache', 'ache', 'achi', 'aachcn', 'aacce', 'aadbr', 'adbi', 'adb', 'aadbq', 'aabaßfeen', 'aaein', 'aaekcta',
													'aabcd', 'aabc', 'lop', 'chr', 'lli', 'lhyww', 'ttll', 'lch', 'lcg', 'lcf', 'lcfv', 'nsö', 'chp', 'pll', 'jvk', 'aahpo', 'aacli', 'aafj', 'aafl', 'aaclönvut', 'ader',
													'aabol', 'aabotr', 'aabo', 'aabne', 'abj', 'aabj', 'aabra', 'aabram', 'tipn', 'cfr', 'pltt', 'vpl', 'pustl', 'cbsa', 'alj', 'aall', 'efo', 'aafo', 'aago', 'aagot',
													'qal', 'qam', 'dta', 'itft', 'aabaari', 'aabbcc', 'aabdl', 'aabamiu', 'aabham', 'aabho', 'aabhe', 'aabh', 'aabec', 'aabeck', 'aabergi', 'aabesti', 'aababi', 'aabach',
													...
													'aaefitfi', 'aaeh', 'aaeho', 'aaencaßapt', 'aadl', 'aadlf', 'aadintr', 'aacjo', 'aacj', 'aacjjhisnnrv', 'aadw', 'aadwmon', 'aaed', 'aactci', 'aace', 'aabna', 'aabtrt',
													'aacftrja', 'aacf', 'aacfo', 'aacfca', 'aacfuak', 'aacftrja', 'aaelgn', 'aael', 'aaeli', 'aaeltpo', 'aaeife', 'aacxflmh', 'efr', 'luu', 'ino', 'aabs', 'aadolrl', 'aaeo',
													'aado', 'aabnd', 'aafe', 'aacv', 'aaci', 'aadaminp', 'aacne', 'aactraejcs', 'aaddodaannddnnandd', 'aacmk', 'aeuo', 'aaboc', 'aabldtech', 'affi', 'aaffi', 'aahfi', 'aaha', 
													'aadolf', 'aadolfa', 'aadolffi', 'aadolfi', 'aadolfin', 'aadolfink', 'aadiiri', 'aabcpk', 'aabcu', 'aabwl', 'aaccid', 'aabtek', 'acjg', 'aahanno', 'ljd', 'tts', 'gna',
													'aacdmo', 'aacd', 'aacdsöri', 'aadgl', 'aadll', 'aadnmukko', 'aem', 'aaem', 'aadu', 'aaduaa', 'aadvlkae', 'aadwmn', 'aadä', 'aaea', 'aaeac', 'aaee', 'aaeie', 'aaceßtkeßy', 
													'aaeka', 'aadol', 'aaeeva', 'aacti', 'aaclo', 'aacno', 'aacnos', 'abm', 'abmi', 'aabmi', 'aabmsp', 'aacla', 'aadalsg', 'aadof', 'aadr', 'aadru', 'ahtcc', 'aacamfa', 'aaca',
													'aahß', 'aaia', 'aaiani', 'aaie', 'aaiia', 'aaifi', 'aaifn', 'aaiel', 'aaiio', 'aaiitj', 'aaija', 'aaikslla', 'aaila', 'aaile', 'aaili', 'aaeb', 'jbmä', 'ndt', 'aeto', 'aetr',
													'aair', 'aairp', 'aaiu', 'aaiuatw', 'aaiumwmm', 'aaiuu', 'aaiuub', 'aaiv', 'aaiyy', 'aaizo', 'aaiß', 'aajala', 'aajja', 'aajmf', 'aajne', 'ablqu', 'abmnkd', 'abnn', 'aabdf',
													'abnu', 'aboa', 'aboae', 'aboas', 'aboba', 'abobo', 'abobsen', 'abodefgb', 'abodetgh', 'abol', 'abor', 'abot', 'abpe', 'aabp', 'abp', 'abq', 'abv', 'abrh', 'abrg', 'aabaasr',
													'abta', 'absä', 'abwaf', 'abzu', 'abßbf', 'acb', 'acbe', 'accii', 'accilltl', 'acd', 'ace', 'acdi', 'acfh', 'acfa', 'acfh', 'acgna', 'acgu', 'achr', 'aci', 'acht', 'aabis',
													'acjjaflbioßaro', 'ackm', 'acm', 'acn', 'aco', 'acr', 'acq', 'acu', 'acw', 'acy', 'acwo', 'acls', 'acrv', 'acssr', 'aacs', 'acs', 'actc', 'acts', 'actni', 'acto', 'acva', 'acxe',
													'adc', 'adce', 'adcirc', 'adclc', 'adcle', 'adclf', 'adclf', 'adde' 'addr', 'afj', 'afjr', 'afjm', 'afkw', 'afky', 'afllßbku', 'afll', 'afnn', 'aabyc', 'aabmm', 'aabalsnmne',
													'aflf', 'aflfa', 'aflfaf', 'aflfc', 'aflfeoßa', 'aflidn', 'aflj', 'aflimr', 'aflk', 'afllfo', 'afllijli', 'aflr', 'afltr', 'aflu', 'aflv', 'afn', 'afna', 'afnd', 'afne', 'aabde',
													...
													'agjls', 'aglksr', 'aglxvä', 'agrr', 'ags', 'agsb', 'agsjm', 'agsk', 'agsm', 'agtl', 'agtm', 'ahc', 'ahcs', 'aaim', 'aim', 'aaini', 'aain', 'aio','aaioaj', 'aaionk', 'aagmt',
													...
													'aabbau', 'aabba', 'aabbad', 'aabbe', 'aabbergetleatern', 'aabber', 'aabb', 'aabbs', 'aabbsk', 'aabbss', 'aabbsa', 'aabbsaa', 'aabbt', 'aabberg', 'aabbl', 'aabbmbi', 'aabbo', 
													...
													'aabalf', 'aabf', 'aabffl', 'aabfd', 'aabfo', 'aabfos', 'aabfsa', 'abbd', 'abbi', 'abbm', 'abbo', 'abbor', 'aabend', 'aabara', 'aabca', 'aabcabiibi', 'aabani', 'aabitfu', 'aaßaa',
													...
													'aabatjec', 'aabcn', 'aabcnra', 'aabcnras', 'aaballan', 'aabdatonta', 'aatl', 'aatnu', 'aatlnt', 'aabaatl', 'aabcbm', 'aabci', 'aabekatt', 'aabeq', 'acä', 'adalrnina', 'aabmwwb',
													...
													'ahm', 'aahmhmnßumrumhaammhmnn', 'aahmtkse', 'ahmff', 'ahme', 'aiig', 'aiif', 'aiik', 'aiie', 'aiit', 'aiirli', 'aiio', 'aiji', 'aijj', 'ailpg', 'ainc', 'aacxabixb', 'aabhf',
													...
													'aabrhatw', 'aaboxi', 'aabaife', 'aacatjji', 'aacaos', 'aabbd', 'aahc', 'aahcm', 'aachenirf', 'aabmsfc', 'ffood', 'cpizooti', 'aabborgi', 
													'aaberra',
													]
