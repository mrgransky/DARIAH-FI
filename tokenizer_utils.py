	...
	try:
		...
		lemmas_list = [ 
			...
			if (
				...
				and not re.search(r"(nens|kaupungissa|kaupungista|kaupungit|gatans|bergs|bergin|gatan|grens|sons|lunde|lunda|lunds|lundille|lundilta|lundilla|lundiin|lundia|lundin|lundissa|holma|holme|stads|stadens)$", wlm) # safer...
