...
with HiddenPrints():
	...
	my_custom_stopwords = ['btw', "could've", "n't","'s","—", "i'm", "'m", 
													...
													'wäi', 'wähöh', 'wäisct', 'wäk', 'aabp', 'aack', 'aacl', 'baacl', 'iaaclu', 'iaa', 'iaaf', 'iaafr', 'iaaf', 'laaclu', 'laad', 'qaa', 'qad', 'qahn', 'qaj',
													...
													'aabol', 'aabittaisitii', 'aabenras', 'aabne', 'aabj', 'aabram', 'tipn', 'cfr', 'pltt', 'vpl', 'pustl', 'cbsa', 'alj', 'aall', 'efo', 'efr', 'luu', 'ino',
													 'qal', 'qam', 'dta', 'itft',
													]
