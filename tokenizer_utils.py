...
with HiddenPrints():
	...
	# my_custom_stopwords = ['btw','ive', 'oops', 'tmt', 'ocb', 'rdf', 'alf', 'frk', 'albi', 'aldiz', 'baizik', 'bukatzeko', 'ift', 'jja', 'lrhe', 'iih', 'rno', 'jgfj', 'puh', 'knr', 'rirrh', 
	# 											'inc', 'per', 'ops', 'vpv', 'ojv', 'rva', 'hvr', 'nfn', 'smk', 'lkm', 'quo', 'utf', 'hfvo', 'mim', 'htnm', 'edv', 'ell', 'gen', 'fjh', 'fji','klo','nro', 'vol', 'amp', 
	# 											'edota', 'eze', 'ezpabere', 'ezpada', 'ezperen', 'gainera', 'njj', 'aab', 'arb', 'tel', 'fkhi', 'oii', 'rji', 'ynn', 'eene', 'eeni', 'eeno', 'eenj', 'eenip', 'eenk',
	# 											'gainerontzean', 'guztiz', 'hainbestez', 'horra', 'onların', 'ordea', 'hel', 'ake', 'oeb', 'rhr', 'trl', 'amt', 'nen', 'mnl', 'krj', 'laj', 'nrn', 'aakv', 'aal', 'sid', 
	# 											'osterantzean', 'sha', 'δ', 'δι', 'агар-чи', 'аз-баски', 'афташ', 'бале', 'баҳри', 'болои', 'валекин', 'вақте', 'вуҷуди', 'гар', 'гарчанде', 'даме', 'карда', 
	# 											'кошки', 'куя', 'кӣ', 'магар', 'майлаш', 'модоме', 'нияти', 'онан', 'оре', 'рӯи', 
	# 											'сар', 'тразе', 'хом', 'хуб', 'чаро', 'чи', 'чунон', 'ш', 'шарте', 'қадар',	'ҳай-ҳай', 'ҳамин', 'ҳатто', 'ҳо', 'ҳой-ҳой', 'ҳол', 'ҳолате', 'ӯим', 'באיזו', 'בו', 'במקום', 
	# 											'בשעה', 'הסיבה', 'לאיזו', 'למקום', 'מאיזו', 'מידה', 'מקום', 'סיבה', 'ש', 'שבגללה', 'שבו', 'תכלית', 'أفعل', 'أفعله', 'انفك', 'برح', 'سيما', 'कम', 'से', 'ἀλλ',
	# 											'hyv', 'kpl', 'ppt', 'ebr', 'emll', 'cdcdb', 'ecl', 'jjl', 'cdc', 'cdb', 'aga', 'ldr', 'lvg', 'zjo', 'cllcltl', 'obs', 'annan', 'huom', 'ajl', 
	...
	# 											'bähr', 'bäl', 'bäg', 'bäm', 'bän', 'böf', 'böb', 'böc', 'böd', 'bög', 'bögh', 'böh', 'böhl', 'böhlc', 'böhm', 'böj', 'böl', 'böo', 'böp', 'caa', 'caai', 'caari', 'cad', 'cabl', 'irigbf',
	# 											]
