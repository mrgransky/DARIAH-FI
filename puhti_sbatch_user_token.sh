...
#SBATCH --job-name=nikeQ_all_spm_exclude_users_with_all_zero_cols
...
ddir="/scratch/project_2004072/Nationalbiblioteket/dataframes_xx732" # x58: 30-80 & 725-731
