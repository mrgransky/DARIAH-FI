...
#SBATCH -J nikeY_stanzaTK_debug_smallBoW
...
python -u RecSys_usr_token.py --inputDF $dfs_dir/nikeY.docworks.lib.helsinki.fi_access_log.07_02_2021.log.dump --lmMethod 'stanza' --qphrase 'helsingin kaupunginteatteri'
