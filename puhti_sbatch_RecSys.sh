...
#SBATCH -J nikeX_stanzaTK_cbow_result
...
python -u RecSys_usr_token.py --inputDF $dfs_dir/nikeX.docworks.lib.helsinki.fi_access_log.07_02_2021.log.dump --lmMethod 'stanza' --qphrase 'helsingin suomalainen säästöpankki'
