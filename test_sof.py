...
t=time.time()
df1=get_rnd_df(row=np.random.randint(low=2e3, high=2e3), col=np.random.randint(low=1e6, high=3e6))
df2=get_rnd_df(row=np.random.randint(low=2e3, high=2e3), col=np.random.randint(low=1e5, high=1e6))
